The contention that there is a large and growing gap between our advancing technological capabilities and our individual and collective wisdom to use them well.

This widening gap is a major contributor to [[Existential Risk]] as we invent new, powerful technologies that if mis-used could kill all of humanity e.g. nuclear weapons, AI, bioweapons such as nano-viruses.

![image](https://github.com/user-attachments/assets/b7531ad3-2cbc-431e-a6b5-5317c2843640)

*Fig: from [Bridging the Wisdom Gap (Geoff Mulgan and Rufus Pollock, 2020)](https://lifeitself.org/blog/2020/06/22/bridging-the-wisdom-gap)*
